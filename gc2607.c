...
static int gc2607_probe(struct i2c_client *client)
{
	...
	/* Required in kernel 6.6+: ipu_bridge notifier matches by fwnode.
	 * Without this, v4l2_async_register_subdev succeeds but the sensor
	 * never appears in the media topology. */
